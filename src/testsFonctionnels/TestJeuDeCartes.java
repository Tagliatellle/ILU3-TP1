...
//
//this.typesDeCartes[5] = new Configuration(new Parade(Type.FEU), 14);
//
//this.typesDeCartes[6] = new Configuration(new FinLimite(), 6);
//
//this.typesDeCartes[7] = new Configuration(new Parade(Type.ESSENCE), 6);
//
//this.typesDeCartes[8] = new Configuration(new Parade(Type.CREVAISON), 6);
//this.typesDeCartes[9] = new Configuration(new Parade(Type.ACCIDENT), 6);
//
//this.typesDeCartes[10] = new Configuration(new Attaque(Type.FEU), 5);
//
//
//this.typesDeCartes[12] = new Configuration(new Attaque(Type.CREVAISON), 3);
//
//this.typesDeCartes[13] = new Configuration(new Attaque(Type.ACCIDENT), 3);